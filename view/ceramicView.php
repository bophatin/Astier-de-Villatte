...
<head>
	...
	<title>Ceramic - Astier de Villatte</title>
</head>
		...
		<div class="container-section-1">
			<div class="container-sec1-left">
				<div class="background-left">
					<div>
						<div class="title-left">Ceramic</div>
			...
			<div class="container-sec1-right"><img src="public/img/collection-ceramic.jpg"></div>
		</div>
	</div>
	...
	<div id="wrapper-section-2">
		<div class="background-section2">
			<ul class="container-articles">
				<li class="article">
					<img src="public/img/ceramic-hand.jpg">
				...
				<li class="article">
					<img src="public/img/ceramic-cup.jpg">
					<div class="desc-hover">
						<div class="label-art">
							<div class="title-art">
                                <p>Tasse John</p>
				...
				<li class="article">
					<img src="public/img/ceramic-plate.jpg">
					<div class="desc-hover">
						<div class="label-art">
							<div class="title-art">
                                <p>Coupelle John Derian</p>
                                <p>62 €</p>
							</div>
						</div>
					</div>
